module.exports =   {
  methods: {
      ...
      display: require('../methods/display'),
      preFilter: require('../methods/preFilter'),
      ...
      initSelect2Filters: require('../methods/init-select2-filters'),
      ...
      isMultiListFilter: require('../methods/is-multi-list-filter'),
      warningRowClass: require('../methods/warningRowClass'),
      sortableSelectedClass: require('../methods/sortable-selected-class'),
      exportable: require('../methods/exportable'),
      exportData: require('../methods/export-data'),
      SortableConfig: require('../config/sortable-config')
